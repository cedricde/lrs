...
REM le logiciel fooox n'a pas d'installateur donc on le copie directement dans program files et on place un raccourci des executables sur le bureau et dans "démarrer" pour tous les utilisateurs

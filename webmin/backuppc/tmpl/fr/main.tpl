...
<FORM METHOD="post" ACTION="affiche.cgi{GET_DATA}">
  ...
  <p>
    <ul>
      <li> 
        <a HREF="" onClick="window.open('/help.cgi/backuppc/index#xfer','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A> M&eacute;thode de sauvegarde :
...
<!-- END user_pass -->
      ...
      <li>
        <a HREF="" onClick="window.open('/help.cgi/backuppc/index#shares','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A> Dossiers partag&eacute;s :
	  <UL>
            <li>
              <!-- BEGIN share_row -->
                 {SHARE},
      ...
      <!-- BEGIN auth_ssh -->
      <li>
        <a HREF="" onClick="window.open('/help.cgi/backuppc/index#ssh','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A> Authentification par SSH : 
  ...
  <table cellpadding="2" cellspacing="0" border="0" width="100%" class="cadre">
    <tr>
      <td bgcolor="#e2e2e2">&nbsp;<font face="arial" size="3"><b>{HOST} : Configurer en DHCP</b></font>

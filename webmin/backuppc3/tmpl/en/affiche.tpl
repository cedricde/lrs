  ...
  <TABLE BORDER=1 CELLPADDING=5 ALIGN="center">
    <TR>
      <TH BGCOLOR="#e2e2e2">
	   ...
	   <TH ALIGN="LEFT" BGCOLOR="#e2e2e2">Configuration file of {HOST}</TH>
           <TH WIDTH="25%" BGCOLOR="#ffffff"><A HREF="host_config.cgi{GET_DATA_BREF}">Change configuration</A></TH>
        </TR></TABLE>
      </TH>
    </TR>
    <TR ALIGN="left">

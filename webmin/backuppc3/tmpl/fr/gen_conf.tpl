...
<INPUT TYPE="hidden" NAME="register" VALUE="0">
  ...
  <TABLE BORDER=1 CELLPADDING=5 ALIGN="center">
    ...
    <TR>
      ...
      <TD BGCOLOR="#e2e2e2"><A HREF="index.cgi?action=editConfig">Configuration avancée</A></TD>
    </TR>
  
    <TR>
      <TD COLSPAN="2">
      <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#wakeup','help','width=400,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>
    ...
    <TR>
      <TD COLSPAN="2">
       <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#maxbackups','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>
        Nombre max. de sauvegardes simultanés : <INPUT TYPE="text" NAME="maxbackups" VALUE="{MAXBACKUPS}" SIZE="3">
      </TD>
    </TR>
    <TR>
      <TD COLSPAN="2">
           <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#blackou','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>
    ...
    <TR>
      <TD COLSPAN="2">
           <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#dhcplist','help','width=450,height=250,scrollbars=yes')" ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>

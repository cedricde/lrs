...
<A HREF="wakeup.cgi?start_hour={HOUR}&end_hour={END_HOUR}">de</A>, 
<A HREF="wakeup.cgi?start_hour={START_HOUR}&end_hour={HOUR}">à</A> 
<BR>
{NEW_COLUMN_END}
<!-- END wakeup_row --> 
  </TR>
  <TR ALIGN="CENTER">
    <TD COLSPAN="4">
      <INPUT TYPE="button" VALUE="Valider" onClick="passHours()">

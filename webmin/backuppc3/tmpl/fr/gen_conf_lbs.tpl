...
<FORM NAME="main_form" METHOD="post" ACTION="gen_conf.cgi">
  ...
  <table cellpadding="2" cellspacing="0" border="0" width="100%" class="cadre">
    <tr>
      <td bgcolor="#e2e2e2">&nbsp;<font face="arial" size="3"><b>Configuration de la sauvegarde ( <A HREF="index.cgi?action=editConfig">Configuration avancée</A> )</b></font></td>
    </tr>
  </table>
  <p>
    <ul>
     <li>
        <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#wakeup','help','width=400,height=250,scrollbars=yes')"
     ...
     <li>
       <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#maxbackups','help','width=450,height=250,scrollbars=yes')"
          ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>
     ...
     <li>
       <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#blackout','help','width=450,height=250,scrollbars=yes')"
          ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>
  ...
  <p>
    <ul>
      <li>
        <A HREF="" onClick="window.open('/help.cgi/backuppc3/index#dhcplist','help','width=450,height=250,scrollbars=yes')"
           ALT="Aide" TITLE="Aide"><IMG SRC="images/qm.png" BORDER="0"></A>

...
void pass_1_pass_2_build_the_tree (void)
{
	...
	if (are_there_used_leaves (i, nr_to_read)) {
		...
		for (j = 0; j < nr_to_read; j ++) {
		    ...
		    print_how_far (&handled_blocks, g_blocks_to_read, 1, fsck_quiet (fs));

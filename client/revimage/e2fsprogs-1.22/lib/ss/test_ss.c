 ...
 *------------------------------------------------------------------
 *
 * $Source: /home/cvs/lbs/revimage/e2fsprogs-1.22/lib/ss/test_ss.c,v $
 * $Revision$
 * $Date: 2002/07/25 15:56:20 $
 * $State: Exp $
 * $Author: ludo $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1  2002/07/25 15:56:20  ludo
 * .
 *
...
static char const rcsid_test_c[] =
    "$Header: /home/cvs/lbs/revimage/e2fsprogs-1.22/lib/ss/test_ss.c,v 1.1 2002/07/25 15:56:20 ludo Exp $";
#endif /* lint */
